...
Along the way, while building everything, I took notes on what I learned about semantic HTML, responsiveness, CSS Variables, and Media Queries.
...
* Add more pages.
* Add a search bar.
* Improve the website design with different colors.
* Add animations and page transitions.
* Add a favicon.
* Improve the design for mobile devices.
* Improve the sidebar so it is no longer fixed.

# ▶️ Running the project
To run the project in your local environment, follow these steps:
1. Clone the repository to your machine.
2. Run the project with the **Live Server** or **Live Preview** extensions in VS Code.
3. Open `http://127.0.0.1:3000/index.html` in your web browser, or use your preferred extension.

# 🎥 Video
https://github.com/user-attachments/assets/5c5959a7-8e09-49f7-863b-d2bc4061b7e0
